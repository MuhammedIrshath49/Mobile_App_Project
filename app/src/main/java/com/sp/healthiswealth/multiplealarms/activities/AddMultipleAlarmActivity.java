package com.sp.healthiswealth.multiplealarms.activities;
...
import com.sp.healthiswealth.R;
import com.sp.healthiswealth.multiplealarms.beans.MultipleAlarm;
import com.sp.healthiswealth.multiplealarms.constants.MultipleAlarmConstants;
import com.sp.healthiswealth.multiplealarms.database.MultipleAlarmDataSource;
import com.sp.healthiswealth.multiplealarms.fragments.DatePickerFragment;
import com.sp.healthiswealth.multiplealarms.fragments.TimePickerFragment;
import com.sp.healthiswealth.multiplealarms.helpers.AlarmHelper;
import com.sp.healthiswealth.multiplealarms.utils.Utility;

import java.util.Calendar;
import java.util.Date;

import static com.sp.healthiswealth.multiplealarms.constants.MultipleAlarmConstants.DAY_OF_WEEK_SEPERATOR;
...
public class AddMultipleAlarmActivity extends AppCompatActivity {
    ...
    private void populateFormValues(Intent intent) {
        ...
        TextView fromTime = (TextView) findViewById(R.id.tv_multiple_alarm_from_time);
        TextView toTime = (TextView) findViewById(R.id.tv_multiple_alarm_to_time);
        TextView fromDate = (TextView) findViewById(R.id.tv_multiple_alarm_from_date);
        TextView toDate = (TextView) findViewById(R.id.tv_multiple_alarm_to_date);
        EditText repeat = (EditText) findViewById(R.id.et_multiple_alarms_repeat);
    ...
    private MultipleAlarm extractUserInput() {
        ...
        TextView tvFromTime = (TextView) findViewById(R.id.tv_multiple_alarm_from_time);
        TextView tvToTime = (TextView) findViewById(R.id.tv_multiple_alarm_to_time);
        TextView tvFromDate = (TextView) findViewById(R.id.tv_multiple_alarm_from_date);
        TextView tvToDate = (TextView) findViewById(R.id.tv_multiple_alarm_to_date);
        EditText etRepeat = (EditText) findViewById(R.id.et_multiple_alarms_repeat);
